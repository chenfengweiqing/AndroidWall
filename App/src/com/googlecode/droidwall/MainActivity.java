...
public class MainActivity extends Activity implements OnCheckedChangeListener, OnClickListener {
    private final static String TAG = "android。wall";
    ...
    private void checkPreferences() {
        ...
        if (changed) {
            ...
            Log.d(TAG, "checkPreferences: changed " + changed);
        }
    }
    ...
    private void toggleLogEnabled() {
        ...
        if (Api.isEnabled(this)) {
            ...
            Log.d(TAG, "toggleLogEnabled: Api.isEnabled false");
        }
            ...
            final Handler handler = new Handler() {
                public void handleMessage(Message msg) {
                    if (progress != null) {
                        ...
                        Log.d(TAG, "handleMessage: progress is null");
                    }
                    showApplications();
                }
            };
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (progress != null) {
                    ...
                    Log.d(TAG, "showRules handleMessage: progress is null ");
                }
                if (!Api.hasRootAccess(MainActivity.this, true)) {
                    return;
                } else {
                    Log.d(TAG, "showRules Api.hasRootAccess:  is true ");
                }
        ...
        handler = new Handler() {
            public void handleMessage(Message msg) {
                if (progress != null) {
                    ...
                    Log.d(TAG, "showLog handleMessage: progress is null ");
                }
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (progress != null) {
                    ...
                    Log.d(TAG, "clearLog handleMessage: progress is null ");
                }
                if (!Api.hasRootAccess(MainActivity.this, true)) {
                    return;
                } else {
                    Log.d(TAG, "clearLog Api.hasRootAccess:  is true ");
                }
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (progress != null) {
                    ...
                    Log.d(TAG, "applyOrSaveRules handleMessage: progress is null ");
                }
                if (!Api.hasRootAccess(MainActivity.this, true)) {
                    return;
                } else {
                    Log.d(TAG, "applyOrSaveRules Api.hasRootAccess:  is true ");
                }
                if (enabled) {
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (progress != null) {
                    ...
                    Log.d(TAG, "purgeRules handleMessage: progress is null ");
                }
                if (!Api.hasRootAccess(MainActivity.this, true)) {
                    return;
                } else {
                    Log.d(TAG, "purgeRules Api.hasRootAccess:  is true ");
                }
